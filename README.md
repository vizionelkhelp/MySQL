...
```
curl https://github.com/vizionelkhelp/vizion.ai/blob/master/beat-install-scripts/install-config-mysql.sh > install-config-mysql.sh; chmod a+x  install-config-mysql.sh; ./install-config-mysql.sh _PLACEHOLDER_API_ENDPOINT_
```
...
5) Choose the ```MySQL``` module and click OK.
